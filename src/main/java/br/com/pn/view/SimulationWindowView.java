...
public abstract class SimulationWindowView extends JFrame implements TreeSelectionListener {
	...
	private PetriNetUI petriNet = null;
	private TreeNodeState treeNodeState = null;

	public SimulationWindowView(PetriNetUI petriNet,	TreeNodeState treeNodeState) {
		super();
...
//			jPanelBody02.setBorder(BorderFactory.createLineBorder(Color.BLACK));
	...
	public JLabel getLbTitleTree() {
		if(lbTitleTree == null){
			lbTitleTree = new JLabel("Sequência de disparos");
		}
		return lbTitleTree;
	}
	...
	protected DefaultMutableTreeNode getRootNode() {
		if (rootNode == null) {
			rootNode = new DefaultMutableTreeNode(treeNodeState);
		}
		return rootNode;
	}
	...
	protected PetriNetUI getPetriNet() {
		return this.petriNet;
	}
	
	protected TreeNodeState getTreeNodeState() {
